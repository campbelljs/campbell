...
exports.childMixin = function (Campbell) {
  ...
  Campbell.prototype.$forceReload = async function () {
    ...
    // destroy this instance before creating a new one (allow to free port for example when component is a server)
    // FIXME: how are other components supposed to handle transition period when this is destroyed and new instance isn't mounted ?
    await this.$destroy();
